...
export function EditFunnelModal({ funnel, open, onOpenChange }: EditFunnelModalProps) {
  ...
  useEffect(() => {
    if (funnel) {
      setName(funnel.name);
      setAutoCreateNext(funnel.auto_create_next);
      setGeneratesContract(funnel.generates_contract);
      setContractPromptText(funnel.contract_prompt_text ?? '');
    }
  }, [funnel]);
      ...
      <DialogContent className="max-w-md">
        ...
        <DialogFooter>
          ...
          <Button 
            ...
            disabled={!name.trim() || updateFunnel.isPending}
          >
